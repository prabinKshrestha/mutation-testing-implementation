...
After executing the command mentioned above, the web page will open in the default browser, displaying the report as follows. You can preview the report on [Survived Example Mutation Report](documentation/assets/survived-mutation-run-mutation-report.html).
...
As before, after the run of the above command, it should open the web page with the following result. You can also preview the report on [All Killed Example Mutation Report](documentation/assets/all-killed-mutation-report.html).
